...
def load_CIFAR10_C(num_samples, corruption, severity):

    # corr_dir = '/local/rcs/yunyun/SelfSupDefense-random-experiments/data/CIFAR-10-C/'

    x_test, y_test = load_cifar10c(num_samples, severity, './data', False, [corruption])
